            ...
            <div className="glass-panel p-4 rounded-2xl sticky top-0 z-10">
                ...
                {!previewUrl ? (
                    ...
                    <div className="relative rounded-xl overflow-hidden bg-black/5">
                        ...
                        <button
                            onClick={() => { setPreviewUrl(null); setUploadFile(null); }}
                        ...
                        <button
                            ...
                            className="absolute bottom-2 right-2 px-4 py-2 bg-nh-green text-white rounded-lg font-bold shadow-lg disabled:opacity-50"
                        >
